...
(gen_random_uuid(), 'ペペロンチーノ',  'ぺぺろんちーの',     'western', 'easy', 'にんにくと唐辛子だけ。材料が少なく作れる'),
(gen_random_uuid(), 'たらこスパゲッティ', 'たらこすぱげってぃ', 'western', 'easy', 'ほぐしたたらこを和えるだけ。火を使うのは麺だけ'),
(gen_random_uuid(), 'ジェノベーゼ',   'じぇのべーぜ',      'western', 'easy', 'バジルの香りを立たせたソースを絡める'),
(gen_random_uuid(), 'ボンゴレビアンコ', 'ぼんごれびあんこ',   'western', 'easy', 'あさりの出汁で仕上げる。砂抜きだけ前もって'),
(gen_random_uuid(), 'きのこのクリームパスタ', 'きのこのくりーむぱすた', 'western', 'easy', 'きのこを炒めて生クリームで伸ばす'),
(gen_random_uuid(), 'ミックスサンドイッチ', 'みっくすさんどいっち', 'western', 'easy', '具を挟んで切るだけ。持ち運びにも向く'),
(gen_random_uuid(), 'ホットサンド',   'ほっとさんど',      'western', 'easy', '挟んで焼くだけ。中身は残り物でも成立する'),
(gen_random_uuid(), 'ベーコンレタスサンド', 'べーこんれたすさんど', 'western', 'easy', 'ベーコンを焼いて挟む。野菜も一緒に取れる'),
(gen_random_uuid(), 'フレンチトースト', 'ふれんちとーすと',   'western', 'easy', '卵液に浸して焼く。前夜に浸しておくと楽'),
(gen_random_uuid(), 'ピザトースト',   'ぴざとーすと',      'western', 'easy', '食パンに具をのせて焼く。朝食にも軽い夕食にも'),
(gen_random_uuid(), 'チーズトースト',  'ちーずとーすと',     'western', 'easy', 'のせて焼くだけ。品数が足りない日の一枚'),
(gen_random_uuid(), 'クロックムッシュ', 'くろっくむっしゅ',   'western', 'easy', 'ハムとチーズを挟んでソースをかけて焼く'),
(gen_random_uuid(), 'オムレツ',      'おむれつ',          'western', 'easy', '卵3個で作れる。形を整えるのは慣れ次第'),
(gen_random_uuid(), 'スパニッシュオムレツ', 'すぱにっしゅおむれつ', 'western', 'easy', 'じゃがいもを入れて厚く焼く。冷めても旨い'),
(gen_random_uuid(), 'ジャーマンポテト', 'じゃーまんぽてと',   'western', 'easy', 'じゃがいもとベーコンを炒めるだけ'),
(gen_random_uuid(), 'ポークソテー',   'ぽーくそてー',      'western', 'easy', '筋を切って焼くだけ。厚切りでも失敗が少ない'),
(gen_random_uuid(), 'ステーキ',      'すてーき',          'western', 'easy', '焼くだけだが、休ませる時間で仕上がりが変わる'),
(gen_random_uuid(), 'ハンバーガー',   'はんばーがー',      'western', 'easy', 'パティを焼いて挟む。好きな具を足せる'),
(gen_random_uuid(), 'ミートボールのトマト煮', 'みーとぼーるのとまとに', 'western', 'easy', '丸めて煮るだけ。多めに作って翌日にも回せる'),
(gen_random_uuid(), 'ドリア',        'どりあ',            'western', 'easy', 'ご飯にソースをかけて焼く。余りご飯の使い道に'),
(gen_random_uuid(), 'ピラフ',        'ぴらふ',            'western', 'easy', '具材と米を炒めて炊く。一皿で完結する'),
(gen_random_uuid(), 'シーザーサラダ',  'しーざーさらだ',     'western', 'easy', 'レタスにドレッシングとチーズを絡める'),
(gen_random_uuid(), 'コブサラダ',     'こぶさらだ',        'western', 'easy', '具を角切りにして並べる。これだけで主菜になる'),
(gen_random_uuid(), 'カプレーゼ',     'かぷれーぜ',        'western', 'easy', '切って並べるだけ。トマトの質がそのまま出る'),
(gen_random_uuid(), 'ニース風サラダ',  'にーすふうさらだ',    'western', 'easy', 'ツナと卵を合わせた食べ応えのあるサラダ'),
(gen_random_uuid(), 'マカロニサラダ',  'まかろにさらだ',     'western', 'easy', '茹でて和えるだけ。作り置きにも向く'),
(gen_random_uuid(), 'クラムチャウダー', 'くらむちゃうだー',   'western', 'easy', 'あさりの缶詰を使えば短時間で仕上がる'),
(gen_random_uuid(), 'かぼちゃのポタージュ', 'かぼちゃのぽたーじゅ', 'western', 'easy', '煮て潰して伸ばすだけ。甘みで子どもも食べやすい'),
(gen_random_uuid(), 'ポークビーンズ',  'ぽーくびーんず',     'western', 'easy', '豆と豚肉をトマトで煮る。水煮豆を使えば早い'),
(gen_random_uuid(), 'アヒージョ',     'あひーじょ',        'western', 'easy', 'にんにくと油で煮るだけ。残った油はパンに'),
...
(gen_random_uuid(), 'ビーフストロガノフ', 'びーふすとろがのふ',  'western', 'normal', '牛肉ときのこをサワークリームで煮る'),
(gen_random_uuid(), 'ミートローフ',   'みーとろーふ',      'western', 'normal', '型に詰めて焼く。切り口に卵を覗かせると見栄えする'),
(gen_random_uuid(), 'ローストチキン',  'ろーすとちきん',     'western', 'normal', '下味を付けてオーブンに任せる。焼き時間は長め'),
(gen_random_uuid(), 'ローストポーク',  'ろーすとぽーく',     'western', 'normal', '塊肉を焼いて休ませる。薄く切って盛り付ける'),
(gen_random_uuid(), 'スペアリブのオーブン焼き', 'すぺありぶのおーぶんやき', 'western', 'normal', '漬け込んでから焼く。骨付き肉の食べ応えがある'),
(gen_random_uuid(), 'チキンのハーブ焼き', 'ちきんのはーぶやき',  'western', 'normal', 'ハーブと野菜を天板に並べて一緒に焼く'),
(gen_random_uuid(), 'サルティンボッカ', 'さるてぃんぼっか',   'western', 'normal', '生ハムを重ねて焼くローマの料理。塩気は生ハム任せ'),
(gen_random_uuid(), 'コロッケ',      'ころっけ',          'western', 'normal', '潰して丸めて揚げる。工程は多いが難しくはない'),
(gen_random_uuid(), 'メンチカツ',     'めんちかつ',        'western', 'normal', '肉だねの水分を閉じ込めるのがコツ'),
(gen_random_uuid(), 'クリームコロッケ', 'くりーむころっけ',   'western', 'normal', 'ホワイトソースを冷やし固めてから成形する'),
(gen_random_uuid(), 'エビフライ',     'えびふらい',        'western', 'normal', '背わたを取り、まっすぐ伸ばしてから揚げる'),
(gen_random_uuid(), 'ミラノ風カツレツ', 'みらのふうかつれつ',  'western', 'normal', '薄く叩いた肉に粉チーズ入りの衣を付けて焼く'),
(gen_random_uuid(), 'フィッシュアンドチップス', 'ふぃっしゅあんどちっぷす', 'western', 'normal', '白身魚と芋を揚げる。衣をふわりとさせるのが要'),
(gen_random_uuid(), 'ポークチャップ',  'ぽーくちゃっぷ',     'western', 'normal', '焼いた豚肉をケチャップソースで絡める洋食屋の味'),
(gen_random_uuid(), 'グーラッシュ',   'ぐーらっしゅ',      'western', 'normal', 'パプリカを効かせて牛肉を煮込むハンガリー料理'),
(gen_random_uuid(), 'チリコンカン',   'ちりこんかん',      'western', 'normal', '豆と挽き肉をスパイスで煮込む。パンにもご飯にも'),
(gen_random_uuid(), 'シェパーズパイ',  'しぇぱーずぱい',     'western', 'normal', '挽き肉の上にマッシュポテトを重ねて焼く'),
(gen_random_uuid(), 'ミートパイ',     'みーとぱい',        'western', 'normal', '市販の生地を使えば手が届く。具は前日に作れる'),
(gen_random_uuid(), 'ジャンバラヤ',   'じゃんばらや',      'western', 'normal', 'スパイスを効かせて米ごと炊き込むアメリカ南部の料理'),
(gen_random_uuid(), 'リゾット',      'りぞっと',          'western', 'normal', '出汁を少しずつ加えて米に吸わせる。芯の残し加減が要'),
(gen_random_uuid(), 'ニョッキ',      'にょっき',          'western', 'normal', 'じゃがいもの生地を丸めて茹でる。成形に手間がかかる'),
(gen_random_uuid(), 'ペスカトーレ',   'ぺすかとーれ',      'western', 'normal', '複数の魚介の出汁をトマトソースに移す'),
(gen_random_uuid(), 'アラビアータ',   'あらびあーた',      'western', 'normal', '唐辛子を効かせたトマトソース。辛さの加減が要'),
(gen_random_uuid(), '白身魚のムニエル', 'しろみざかなのむにえる', 'western', 'normal', '粉をはたいてバターで焼く。焦がしバターで香りを出す'),
(gen_random_uuid(), 'サーモンのクリーム煮', 'さーもんのくりーむに', 'western', 'normal', '崩れやすい身を扱いながら生クリームで煮る'),
(gen_random_uuid(), 'ムール貝の白ワイン蒸し', 'むーるがいのしろわいんむし', 'western', 'normal', '貝の掃除さえ済めば蒸すだけ。残った汁も使える'),
(gen_random_uuid(), 'ラタトゥイユ',   'らたとぅいゆ',      'western', 'normal', '夏野菜を別々に炒めてから煮合わせる'),
(gen_random_uuid(), 'オニオングラタンスープ', 'おにおんぐらたんすーぷ', 'western', 'normal', '玉ねぎを飴色になるまで炒める。ここに時間がかかる'),
(gen_random_uuid(), 'ヴィシソワーズ',  'びしそわーず',      'western', 'normal', 'じゃがいもの冷製スープ。裏ごしの丁寧さが出る'),
(gen_random_uuid(), 'エッグベネディクト', 'えっぐべねでぃくと', 'western', 'normal', 'ポーチドエッグとソースを同時に仕上げる段取りが要る'),
...
(gen_random_uuid(), '醤油ラーメン',   'しょうゆらーめん',    'chinese', 'easy', '市販のスープを使えば具を用意するだけ'),
(gen_random_uuid(), '味噌ラーメン',   'みそらーめん',      'chinese', 'easy', '炒めた野菜をのせると一杯で満足できる'),
(gen_random_uuid(), 'タンメン',      'たんめん',          'chinese', 'easy', '野菜をたっぷり煮た塩味の麺。野菜の消費に向く'),
(gen_random_uuid(), '焼きそば',      'やきそば',          'chinese', 'easy', '麺と野菜を炒めるだけ。冷蔵庫の整理にも'),
(gen_random_uuid(), 'あんかけ焼きそば', 'あんかけやきそば',   'chinese', 'easy', '焼いた麺に具だくさんのあんをかける'),
(gen_random_uuid(), '油そば',        'あぶらそば',        'chinese', 'easy', 'スープを作らない分だけ手間が少ない'),
(gen_random_uuid(), 'ジャージャー麺',  'じゃーじゃーめん',    'chinese', 'easy', '肉味噌を作って麺にのせる。作り置きが効く'),
(gen_random_uuid(), 'マーボー春雨',   'まーぼーはるさめ',    'chinese', 'easy', '春雨が汁を吸うので少ない材料で満足感が出る'),
(gen_random_uuid(), '中華粥',        'ちゅうかがゆ',      'chinese', 'easy', '米から煮るだけ。体調が優れない日にも'),
(gen_random_uuid(), 'ネギチャーシュー丼', 'ねぎちゃーしゅーどん', 'chinese', 'easy', '市販のチャーシューとねぎをご飯にのせる'),
(gen_random_uuid(), 'かに玉',        'かにたま',          'chinese', 'easy', 'ふんわり焼いてあんをかける。具は缶詰でも'),
(gen_random_uuid(), 'えびマヨ',      'えびまよ',          'chinese', 'easy', '揚げた海老をソースで和える。市販の惣菜より軽く作れる'),
(gen_random_uuid(), 'ニラレバ炒め',   'にらればいため',     'chinese', 'easy', 'レバーの下処理さえ済めば炒めるだけ'),
(gen_random_uuid(), 'もやしと豚肉の炒め物', 'もやしとぶたにくのいためもの', 'chinese', 'easy', '材料が安く、5分で仕上がる'),
(gen_random_uuid(), '豆苗と豚肉の炒め物', 'とうみょうとぶたにくのいためもの', 'chinese', 'easy', 'シャキッとした食感を残すよう手早く炒める'),
(gen_random_uuid(), 'チンゲン菜と海老の炒め物', 'ちんげんさいとえびのいためもの', 'chinese', 'easy', '色よく仕上げるため強火で短時間に'),
(gen_random_uuid(), '鶏肉とカシューナッツの炒め物', 'とりにくとかしゅーなっつのいためもの', 'chinese', 'easy', 'ナッツの食感が加わる。冷めても食べやすい'),
(gen_random_uuid(), '肉団子の甘酢あん', 'にくだんごのあまずあん', 'chinese', 'easy', '丸めて揚げて絡めるだけ。多めに作れる'),
(gen_random_uuid(), '鶏むね肉の中華蒸し', 'とりむねにくのちゅうかむし', 'chinese', 'easy', '蒸すだけで柔らかい。たれを変えれば飽きない'),
(gen_random_uuid(), '豚バラと白菜の重ね蒸し', 'ぶたばらとはくさいのかさねむし', 'chinese', 'easy', '重ねて蒸すだけ。白菜が多い時期に'),
(gen_random_uuid(), '手羽先の甘辛煮',  'てばさきのあまからに', 'chinese', 'easy', '煮汁に入れて放っておける。骨からの出汁が効く'),
(gen_random_uuid(), '中華風あんかけ豆腐', 'ちゅうかふうあんかけどうふ', 'chinese', 'easy', '豆腐を温めてあんをかけるだけ'),
(gen_random_uuid(), 'バンバンジー',   'ばんばんじー',      'chinese', 'easy', '茹で鶏ときゅうりにごまだれをかける'),
(gen_random_uuid(), '春雨サラダ',     'はるさめさらだ',     'chinese', 'easy', '戻して和えるだけ。もう一品欲しい日に'),
(gen_random_uuid(), 'きゅうりの中華和え', 'きゅうりのちゅうかあえ', 'chinese', 'easy', '叩いて和えるだけ。箸休めになる'),
(gen_random_uuid(), '水餃子',        'すいぎょうざ',      'chinese', 'easy', '茹でるので焼き加減を気にしなくてよい'),
(gen_random_uuid(), 'ワンタンスープ',  'わんたんすーぷ',     'chinese', 'easy', '包む手間はあるが、具は少なくて済む'),
(gen_random_uuid(), 'わかめスープ',   'わかめすーぷ',      'chinese', 'easy', '数分でできる。主菜が重い日に合わせやすい'),
(gen_random_uuid(), 'サンラータン',   'さんらーたん',      'chinese', 'easy', '酸味と辛味を後から足して調整できる'),
(gen_random_uuid(), '中華コーンスープ', 'ちゅうかこーんすーぷ', 'chinese', 'easy', '缶詰と卵で作れる。子どもも食べやすい'),
...
(gen_random_uuid(), 'よだれ鶏',      'よだれどり',        'chinese', 'normal', '茹で鶏に香味だれをかける。たれの配合が味を決める'),
(gen_random_uuid(), '白身魚の中華蒸し', 'しろみざかなのちゅうかむし', 'chinese', 'normal', '蒸し上がりに熱した油をかけて香りを立たせる'),
(gen_random_uuid(), 'えびとブロッコリーの炒め物', 'えびとぶろっこりーのいためもの', 'chinese', 'normal', '海老の下処理と火の入れ具合で食感が変わる'),
(gen_random_uuid(), 'いかと野菜の中華炒め', 'いかとやさいのちゅうかいため', 'chinese', 'normal', 'いかは火を通しすぎると硬くなるので手早く'),
(gen_random_uuid(), '牛肉のオイスターソース炒め', 'ぎゅうにくのおいすたーそーすいため', 'chinese', 'normal', '下味と片栗粉で肉を柔らかく保つ'),
(gen_random_uuid(), '牛肉とセロリの炒め物', 'ぎゅうにくとせろりのいためもの', 'chinese', 'normal', 'セロリの香りを残すため最後に合わせる'),
(gen_random_uuid(), 'えびと卵の炒め物', 'えびとたまごのいためもの', 'chinese', 'normal', '卵を半熟で取り出し、最後に戻すのがコツ'),
(gen_random_uuid(), '鶏肉のねぎ塩炒め', 'とりにくのねぎしおいため', 'chinese', 'normal', 'ねぎをたっぷり使い、塩味で素材を立たせる'),
(gen_random_uuid(), 'にんにくの芽と豚肉の炒め物', 'にんにくのめとぶたにくのいためもの', 'chinese', 'normal', '香りが強く、ご飯が進む。下茹でで食感を整える'),
(gen_random_uuid(), 'ザーサイと豚肉の炒め物', 'ざーさいとぶたにくのいためもの', 'chinese', 'normal', '搾菜の塩気を活かすので味付けは控えめに'),
(gen_random_uuid(), '空芯菜炒め',     'くうしんさいいため',  'chinese', 'normal', '強火で一気に炒めて茎の食感を残す'),
(gen_random_uuid(), '揚げ茄子の香味だれ', 'あげなすのこうみだれ', 'chinese', 'normal', '素揚げした茄子に香味だれを絡める'),
(gen_random_uuid(), '中華風スペアリブ', 'ちゅうかふうすぺありぶ', 'chinese', 'normal', '揚げてから甘酢あんを絡める。骨付きで食べ応えがある'),
(gen_random_uuid(), '豚バラと厚揚げの中華煮', 'ぶたばらとあつあげのちゅうかに', 'chinese', 'normal', '厚揚げが煮汁を吸う。時間をかけるほど味が入る'),
(gen_random_uuid(), '白菜と肉団子の煮込み', 'はくさいとにくだんごのにこみ', 'chinese', 'normal', '肉団子から出た旨味を白菜に含ませる'),
(gen_random_uuid(), 'えびの蒸し餃子',  'えびのむしぎょうざ',  'chinese', 'normal', '海老を粗く刻んで食感を残す。包み方に慣れが要る'),
(gen_random_uuid(), 'ニラ饅頭',      'にらまんじゅう',     'chinese', 'normal', 'ニラをたっぷり包んで焼く。皮は市販でも作れる'),
(gen_random_uuid(), '揚げワンタン',   'あげわんたん',      'chinese', 'normal', '包んで揚げるだけだが、数を作るのに時間がかかる'),
(gen_random_uuid(), '肉まん',        'にくまん',          'chinese', 'normal', '生地を発酵させて包む。蒸し上がりの見極めが要る'),
(gen_random_uuid(), '大根餅',        'だいこんもち',      'chinese', 'normal', 'すりおろした大根を蒸してから焼く。工程が二段階'),
(gen_random_uuid(), '中華おこわ',     'ちゅうかおこわ',     'chinese', 'normal', 'もち米を蒸して具と合わせる。水加減が難しい'),
(gen_random_uuid(), 'くらげの冷菜',   'くらげのれいさい',    'chinese', 'normal', '塩抜きと戻しに時間がかかるが、和えるだけ'),
(gen_random_uuid(), '酸辣湯麺',      'さんらーたんめん',    'chinese', 'normal', '具材を細切りに揃える手間がかかる'),
(gen_random_uuid(), 'パーコー麺',     'ぱーこーめん',      'chinese', 'normal', '揚げた豚肉を麺にのせる。揚げ物と麺を同時に仕上げる'),
(gen_random_uuid(), '牛肉麺',        'ぎゅうにくめん',     'chinese', 'normal', '牛すね肉を煮込んでスープごと麺に合わせる'),
(gen_random_uuid(), '台湾まぜそば',   'たいわんまぜそば',    'chinese', 'normal', '具を別々に仕込んで麺にのせ、混ぜて食べる'),
(gen_random_uuid(), 'ちゃんぽん',     'ちゃんぽん',        'chinese', 'normal', '具材が多く、切り物に時間がかかる'),
(gen_random_uuid(), '皿うどん',      'さらうどん',        'chinese', 'normal', '揚げ麺に熱いあんをかける。あんの濃度が要'),
(gen_random_uuid(), 'ルーロー飯',     'るーろーはん',      'chinese', 'normal', '豚バラを甘辛く煮込んでご飯にかける台湾の定番'),
(gen_random_uuid(), 'トマトと卵のスープ', 'とまととたまごのすーぷ', 'chinese', 'normal', '卵を細く流し入れて筋を作る'),
...
(gen_random_uuid(), '豚キムチ',      'ぶたきむち',        'other', 'easy', 'キムチと豚肉を炒めるだけ。味付けはキムチ任せ'),
(gen_random_uuid(), 'チヂミ',        'ちぢみ',            'other', 'easy', '生地に具を混ぜて焼く。カリッと焼くのがコツ'),
(gen_random_uuid(), 'キンパ',        'きんぱ',            'other', 'easy', '具を並べて巻く韓国風のり巻き。作り置きにも'),
(gen_random_uuid(), 'ヤンニョムチキン', 'やんにょむちきん',   'other', 'easy', '揚げた鶏に甘辛いタレを絡める'),
(gen_random_uuid(), 'チーズタッカルビ', 'ちーずたっかるび',   'other', 'easy', '鶏と野菜を炒めてチーズを絡める。一皿で完結する'),
(gen_random_uuid(), 'ビビン麺',      'びびんめん',        'other', 'easy', '茹でた麺に辛いタレを和える。暑い日に'),
(gen_random_uuid(), 'トッポギ',      'とっぽぎ',          'other', 'easy', '餅を甘辛く煮るだけ。小腹にも主食にも'),
(gen_random_uuid(), 'テンジャンチゲ',  'てんじゃんちげ',     'other', 'easy', '韓国味噌で野菜と豆腐を煮る素朴な鍋'),
(gen_random_uuid(), 'プデチゲ',      'ぷでちげ',          'other', 'easy', 'ソーセージやハムを入れて煮る。冷蔵庫の余り物が使える'),
(gen_random_uuid(), 'スープカレー',   'すーぷかれー',      'other', 'easy', '具材を大きめに切って煮る。ルウを使えば手軽'),
(gen_random_uuid(), 'ドライカレー',   'どらいかれー',      'other', 'easy', '汁気を飛ばして炒める。弁当にも回せる'),
(gen_random_uuid(), 'キーマカレー',   'きーまかれー',      'other', 'easy', '挽き肉なので煮込み時間が短くて済む'),
(gen_random_uuid(), 'カレーうどん',   'かれーうどん',      'other', 'easy', '前日のカレーを出汁で伸ばせば作り直しが要らない'),
(gen_random_uuid(), 'タンドリーチキン', 'たんどりーちきん',   'other', 'easy', 'ヨーグルトとスパイスに漬けて焼くだけ'),
(gen_random_uuid(), 'ロコモコ',      'ろこもこ',          'other', 'easy', 'ハンバーグと目玉焼きをご飯にのせる'),
(gen_random_uuid(), 'ポキ丼',        'ぽきどん',          'other', 'easy', '刺身を漬けてご飯にのせる。火を使わない'),
(gen_random_uuid(), 'スパムおにぎり',  'すぱむおにぎり',     'other', 'easy', '焼いたスパムと卵を挟む。持ち運びやすい'),
(gen_random_uuid(), 'ガーリックライス', 'がーりっくらいす',   'other', 'easy', '炒めるだけ。肉料理の付け合わせにもなる'),
(gen_random_uuid(), 'パッタイ',      'ぱったい',          'other', 'easy', '米麺を戻して炒める。甘酸っぱさが特徴'),
(gen_random_uuid(), 'ミーゴレン',     'みーごれん',        'other', 'easy', '甘辛く炒めるインドネシア風の焼きそば'),
(gen_random_uuid(), 'カオマンガイ',   'かおまんがい',      'other', 'easy', '鶏を茹でて、その汁で米を炊く。鍋一つで済む'),
(gen_random_uuid(), '生春巻き',      'なまはるまき',      'other', 'easy', '巻くだけで火を使わない。具は残り物でも'),
(gen_random_uuid(), 'バインミー',     'ばいんみー',        'other', 'easy', 'バゲットに肉と香草を挟むベトナムのサンドイッチ'),
(gen_random_uuid(), 'ソムタム',      'そむたむ',          'other', 'easy', '青パパイヤを和えるタイのサラダ。辛さは好みで'),
(gen_random_uuid(), 'ヤムウンセン',   'やむうんせん',      'other', 'easy', '春雨と海老を和えるだけ。作り置きが効く'),
(gen_random_uuid(), 'ケサディーヤ',   'けさでぃーや',      'other', 'easy', 'チーズを挟んで焼くだけ。子どもも食べやすい'),
(gen_random_uuid(), 'ブリトー',      'ぶりとー',          'other', 'easy', '具を包むだけ。片手で食べられる'),
(gen_random_uuid(), 'ラップサンド',   'らっぷさんど',      'other', 'easy', '野菜と肉を巻く。朝食にも弁当にも'),
(gen_random_uuid(), 'ピタサンド',     'ぴたさんど',        'other', 'easy', 'ピタパンを開いて詰めるだけ'),
(gen_random_uuid(), 'シャクシュカ',   'しゃくしゅか',      'other', 'easy', 'トマトソースに卵を落とすだけ。フライパン一つで'),
...
(gen_random_uuid(), 'カルビチム',     'かるびちむ',        'other', 'normal', '牛肉と根菜を甘辛く煮込む韓国の祝い料理'),
(gen_random_uuid(), 'タッカンマリ',   'たっかんまり',      'other', 'normal', '鶏を丸ごと煮て、たれを付けて食べる。締めは麺で'),
(gen_random_uuid(), 'ユッケジャン',   'ゆっけじゃん',      'other', 'normal', '牛肉とぜんまいを煮込む辛いスープ。具を裂く手間がある'),
(gen_random_uuid(), 'コムタン',      'こむたん',          'other', 'normal', '牛の骨と肉を長時間煮出した白いスープ'),
(gen_random_uuid(), 'ポッサム',      'ぽっさむ',          'other', 'normal', '茹でた豚バラを野菜で包む。茹で加減が要'),
(gen_random_uuid(), 'カムジャタン',   'かむじゃたん',      'other', 'normal', 'じゃがいもと豚肉を煮込む韓国の鍋'),
(gen_random_uuid(), 'タットリタン',   'たっとりたん',      'other', 'normal', '鶏とじゃがいもを辛く煮る。日本の肉じゃがに近い作り方'),
(gen_random_uuid(), 'カオソーイ',     'かおそーい',        'other', 'normal', '揚げ麺と煮麺を合わせるタイ北部のカレー麺'),
(gen_random_uuid(), 'ラクサ',        'らくさ',            'other', 'normal', 'ココナッツと海老の風味を重ねる東南アジアの麺'),
(gen_random_uuid(), 'バインセオ',     'ばいんせお',        'other', 'normal', '米粉の生地を薄く焼いて具を包むベトナム料理'),
(gen_random_uuid(), 'ブンチャー',     'ぶんちゃー',        'other', 'normal', '焼いた肉をつけ汁と米麺で食べる。炭火の香りが要'),
(gen_random_uuid(), 'ガイヤーン',     'がいやーん',        'other', 'normal', 'スパイスに漬けた鶏をじっくり焼くタイの料理'),
(gen_random_uuid(), 'トムカーガイ',   'とむかーがい',      'other', 'normal', 'ココナッツミルクで鶏を煮る。酸味と辛味の調整が要る'),
(gen_random_uuid(), 'マッサマンカレー', 'まっさまんかれー',   'other', 'normal', 'じゃがいもとナッツを煮込む甘めのタイカレー'),
(gen_random_uuid(), 'サグカレー',     'さぐかれー',        'other', 'normal', 'ほうれん草をペーストにして煮込む'),
(gen_random_uuid(), 'ダルカレー',     'だるかれー',        'other', 'normal', '豆を煮崩して作る。肉を使わないので軽い'),
(gen_random_uuid(), 'チャナマサラ',   'ちゃなまさら',      'other', 'normal', 'ひよこ豆をスパイスで煮込む。作り置きに向く'),
(gen_random_uuid(), 'サモサ',        'さもさ',            'other', 'normal', '具を包んで揚げる。包み方に慣れが要る'),
(gen_random_uuid(), 'ファラフェル',   'ふぁらふぇる',      'other', 'normal', 'ひよこ豆をすり潰して揚げる。前日から豆を戻す'),
(gen_random_uuid(), 'シュクメルリ',   'しゅくめるり',      'other', 'normal', 'にんにくを効かせた鶏のクリーム煮。ジョージアの料理'),
(gen_random_uuid(), 'キョフテ',      'きょふて',          'other', 'normal', 'スパイスを練り込んだ挽き肉を焼くトルコの料理'),
(gen_random_uuid(), 'ジャークチキン',  'じゃーくちきん',     'other', 'normal', 'スパイスに漬け込んで焼くジャマイカの料理'),
(gen_random_uuid(), 'フェイジョアーダ', 'ふぇいじょあーだ',   'other', 'normal', '黒豆と肉を煮込むブラジルの家庭料理'),
(gen_random_uuid(), 'エンパナーダ',   'えんぱなーだ',      'other', 'normal', '具を生地で包んで焼く中南米のパイ'),
(gen_random_uuid(), 'チキンファヒータ', 'ちきんふぁひーた',   'other', 'normal', '焼いた肉と野菜をトルティーヤで巻いて食べる'),
(gen_random_uuid(), 'エンチラーダ',   'えんちらーだ',      'other', 'normal', '具を巻いたトルティーヤにソースをかけて焼く'),
(gen_random_uuid(), 'ピロシキ',      'ぴろしき',          'other', 'normal', '具を包んで揚げるロシアのパン。具は前日に作れる'),
(gen_random_uuid(), 'アドボ',        'あどぼ',            'other', 'normal', '酢と醤油で肉を煮込むフィリピンの家庭料理'),
(gen_random_uuid(), 'シニガン',      'しにがん',          'other', 'normal', '酸味の効いたフィリピンのスープ。野菜がたくさん取れる'),
(gen_random_uuid(), 'ナシチャンプル',  'なしちゃんぷる',     'other', 'normal', '複数のおかずをご飯に少しずつ盛る。品数を作る手間はある'),
